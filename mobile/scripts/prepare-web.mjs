...
if (!v300Text.includes("const V300_VERSION='3.1.3'")) throw new Error('v300.js não identifica a versão 3.1.3.');
if (!v310Text.includes("const VERSION = '3.1.3'")) throw new Error('v310.js não identifica a versão 3.1.3.');
